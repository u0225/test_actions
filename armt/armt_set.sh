...
sed -i 's/define Device\/tl-wdr3320-v2/{n;d}' target/linux/ar71xx/image/tiny-tp-link.mk
sed -i 's/define Device\/tl-wdr3320-v2/a\  $(Device/tplink-16mlzma)' target/linux/ar71xx/image/tiny-tp-link.mk
sed -i 's/  DTS := ZBT-WR8305RT/a\  IMAGE_SIZE := $(ralink_default_fw_size_16M)' target/linux/ramips/image/mt7620.mk
